...
function Featured() {
  ...
  return (
    <div id="service" className="container w-full sm:pt-20 pt-10">
      ...
      <div className="py-10 cards w-full flex flex-col md:flex-row gap-10">
        ...
        >
          ...
          <div  className="card w-full h-[300px] flex items-center rounded-xl overflow-hidden">
            <img
              ...
              src="https://github.com/AniketAgni376/ThoughtsBig/blob/main/src/assets/images/c1.png"
              alt="featured"
            />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="card w-full h-[300px] flex items-center rounded-xl overflow-hidden">
            <img
              className="w-full h-auto object-cover hover:scale-105 transition-all"
              src="https://github.com/AniketAgni376/ThoughtsBig/blob/main/src/assets/images/c2.png"
              alt="featured"
            />
          </div>
        </motion.div>
