...
function HeroSection() {
  return (
    ...
    >
      <div className="textstructure py-[2vh]">
      ...
      <div className="flex items-center justify-between border-t-[3px] border-zinc-800 py-[90px] font-NueueMontreal">
        {[
        ...
        <div className="start flex items-center gap-4">
          <div className="rounded-full border-[1px] font-NeueMontreal border-zinc-500 px-5 py-2 text-sm font-light whitespace-nowrap uppercase">
            Start the Project
          </div>
